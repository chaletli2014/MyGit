...
public class RespirologyDAOImpl implements RespirologyDAO {
	...
	public void generateWeeklyRESDataOfHospital(Date refreshDate) throws Exception {
        ...
        sb.append("insert into tbl_respirology_data_weekly(id,duration,hospitalName,hospitalCode ")
            ...
            .append("   IFNULL((sum(rd.pnum)/count_hos.inNum)*5,0) as pnum, ")
            .append("   IFNULL((sum(rd.aenum)/count_hos.inNum)*5,0) as aenum, ")
            .append("   IFNULL((sum(rd.whnum)/count_hos.inNum)*5,0) as whnum, ")
            .append("   IFNULL((sum(rd.lsnum)/count_hos.inNum)*5,0) as lsnum, ")
            .append("   IFNULL((sum(rd.xbknum)/count_hos.inNum)*5,0) as xbknum, ")
            .append("   IFNULL((sum(rd.xbk1num)/count_hos.inNum)*5,0) as xbk1num, ")
            .append("   IFNULL((sum(rd.xbk2num)/count_hos.inNum)*5,0) as xbk2num, ")
            .append("   IFNULL((sum(rd.xbk3num)/count_hos.inNum)*5,0) as xbk3num, ")
            .append("   IFNULL( ")
            .append("       sum( ")
