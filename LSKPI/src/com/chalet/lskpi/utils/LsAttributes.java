...
public class LsAttributes {
    ...
    public static final StringBuffer SQL_DAILYREPORT_SELECTION_PED
        = new StringBuffer("")
		    ...
		    .append(" sum( 1*IFNULL(pd.whdays_emerging_1,0) + 2*IFNULL(pd.whdays_emerging_2,0) ")
		    ...
		    .append(") / 100 as whdays_emerging,")
		    .append(" sum( 1*IFNULL(pd.whdays_room_1,0) + 2*IFNULL(pd.whdays_room_2,0) ")
