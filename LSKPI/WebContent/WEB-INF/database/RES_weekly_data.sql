...
SELECT 
    ...
    (
        ...
        from tbl_respirology_data rd, tbl_hospital h
        WHERE rd.createdate between DATE_SUB('2014-09-08', Interval 7 day) and '2014-09-08' 
...
SELECT 
    ...
    (
        select count(1) as inNum, h.code 
        from tbl_respirology_data rd, tbl_hospital h
        WHERE rd.createdate between DATE_SUB('2014-09-01', Interval 7 day) and '2014-09-01' 
        and rd.hospitalName = h.name 
        and h.isResAssessed='1' 
        GROUP BY h.code
    ) count_hos 
