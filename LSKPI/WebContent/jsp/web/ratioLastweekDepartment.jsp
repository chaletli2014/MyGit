    ...
    <div data-role="page" id="home">
        ...
        <div data-role="content" data-theme="a">
        	<div data-role="fieldcontain" class="department_img_div">
	            <img alt="" src="<%=basePath%>images/img_bg_res_weekly_w.png" onclick="showReportPage('<%=basePath%>ratioLastweekRes')" style="cursor: pointer;">
        	</div>
        	<div data-role="fieldcontain" class="department_img_div">
	            <img alt="" src="<%=basePath%>images/img_bg_ped_weekly_w.png" onclick="showReportPage('<%=basePath%>ratioLastweekPed')" style="cursor: pointer;">
        	</div>
        </div>
