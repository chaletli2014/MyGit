...
<body onload="checkMessage('${message}')">
    ...
    <div data-role="page" id="home">
        ...
        <div data-role="content" data-theme="a">
        	...
        	<div data-role="fieldcontain" class="department_img_div">
        	<%--
	            <img alt="" src="<%=basePath%>images/img_bg_chestSurgery_daily_w.png" onclick="showDailyReportPage('<%=basePath%>chestSurgeryDailyReport')" style="cursor: pointer;">
        	 --%>
	            <img alt="" src="<%=basePath%>images/img_bg_chestSurgery_daily_w.png" onclick="showCustomrizedMessage('由于KPI系统简化调整，胸外科部分暂时不用填写，敬请注意，谢谢！');" style="cursor: pointer;">
        	</div>
        </div>
