...
<body onload="checkMessage('${message}')">
    ...
    <div data-role="page" id="home">
            ...
            <div class="roundCorner" style="padding:4px;background:#fff;">
	            <table class="mobileReport_table">
	               ...
	               <tr class="mobileReport_table_body">
	                   ...
	                   <td class="report_data_number"><fmt:formatNumber type="percent" value="${weeklyRatioData.inRate}" pattern="#0%"/></td>
	                   <td class="report_data_number"><fmt:formatNumber type="percent" value="${weeklyRatioData.whRate}" pattern="#0%"/></td>
	                   <td class="report_data_number"><fmt:formatNumber type="percent" value="${weeklyRatioData.averageDose}" pattern="#0.00"/></td>
        ...
        <iframe src="${resReportFile}" id="iframepage" scrolling="no" width="100%" onload="javascript:dyniframesize('iframepage');"></iframe>
        <jsp:include page="page_footer.jsp">
            <jsp:param value="<%=basePath%>" name="basePath"/>
            <jsp:param value="ratioLastweekRes" name="backURL"/>
        </jsp:include>
    </div>
</body>  
</html>  